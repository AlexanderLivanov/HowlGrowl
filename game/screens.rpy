...
screen main_menu():
    ...
    python:
        renpy.music.queue("musmenu2.mp3", channel = "music", fadein = 7)
...
#     add TrackCursor("images/main_menu_fon_boxes.png",  25):
#         xpos -88
#     add TrackCursor("images/fly_cloud.png",  30) at moving_cloud:
#         ypos -200
#     add TrackCursor("images/main_menu_fon_Seriy.png",  21):
#         xpos 50
#
#     add TrackCursor("images/semi_eyes.png",  21) at semi_blink:
#         xpos -28 ypos 30
#     add TrackCursor("images/closed_eyes.png",  21) at closed_blink:
#         xpos -28 ypos 30
#
#     add TrackCursor("images/main_menu_fon_dymka.png",  19.5) at moving_tuman
#     add TrackCursor("images/main_menu_fon_dymka.png",  18.5) at moving_tuman:
#         ypos -100 xzoom 1.2
#     add TrackCursor("images/main_menu_fon_figure.png", 20):
#         xpos -6 alpha 0.6
#     add TrackCursor("images/main_menu_fon_zdanie.png",  18)
#     add TrackCursor("images/main_menu_fon_dymka.png",  17) at moving_tuman:
#         ypos 50 xzoom 1.2
#
#     add TrackCursor("images/main_menu_fon_HGtrees.png",15):
#         xpos 0  ypos 0 xzoom 1.1 yzoom 1.1
#     add TrackCursor("images/main_menu_fon_HGlogo.png", 14):
#         xpos 55
#     add "under_button.png":
#         xpos -100
...
################################################################################################
    ...
    add TrackCursor("images/main_menu_fon_winter_boxes.png",  25):
        xpos -88
    add TrackCursor("images/winter_moonpng.png",  40)
    add TrackCursor("images/snow_back.png",  23)at snowfall3:
        alpha 0.7
    add TrackCursor("images/snow_back.png",  23)at snowfall33:
        alpha 0.7
    ...
    add TrackCursor("images/main_menu_fon_winter_dymka.png",  17)
    add TrackCursor("images/main_menu_fon_winter_figure.png", 20)

    add TrackCursor("images/main_menu_fon_winter_HGtrees_back.png", 17):
        xpos 60
    add TrackCursor("images/main_menu_fon_winter_HGtrees_front.png", 15)

    add "images/main_menu_fon_HGlogo.png":
        xpos 0
    add "under_button.png":
        xpos -100
    ...
    imagebutton:
        ...
        hover "images/contin_button_hover.png"
        action ShowMenu("load")
        xpos 879
        ypos 825

    imagebutton:
        idle "images/rest_button_idle.png"
        hover "images/rest_button_hover.png"
        action ShowMenu("load")
        xpos 870
        ypos 880

    imagebutton:
        idle "images/pref_button_idle.png"
        hover "images/pref_button_hover.png"
        action ShowMenu("preferences")
        xpos 893
        ypos 935

    imagebutton:
        idle "images/quit_button_idle.png"
        hover "images/quit_button_hover.png"
        action Quit()
        xpos 923
        ypos 1005

    add TrackCursor("images/snow_front.png",  7) at snowfall1:
        xpos 80 alpha 1.0 xzoom 1.4 yzoom 1.4
    add TrackCursor("images/snow_front.png",  7) at snowfall11:
        xpos 80 alpha 1.0 xzoom 1.4 yzoom 1.4

    add TrackCursor("images/snow_front.png",  0.5) at snowfall4:
        xpos 0 alpha 0.5 xzoom 10.0 yzoom 12.0
    add TrackCursor("images/snow_front.png",  0.5) at snowfall44:
        xpos 0 alpha 0.5 xzoom 10.0 yzoom 12.0

    use infinite_swap

    add "images/TV_menufilter.png"

    add "images/blacks.png" at disolve
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        ...
                        textbutton _("Режим окна") action Preference("display", "window")
                        textbutton _("Весь экран") action Preference("display", "fullscreen")

                vbox:
                    style_prefix "check"
                    label _("Пропустить")
                    textbutton _("Всю болтовню") action Preference("skip", "toggle")
                    textbutton _("После решений") action Preference("after choices", "toggle")
