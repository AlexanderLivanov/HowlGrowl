...
##############################################################################
##КНОПКИ ДЛЯ УПРАВЛЕНИЯ ПРОКРУТКОЙ (добавлять на локации с viewport и после label start)
##############################################################################
...
###        align (0.5, 0.95)
###
###        textbutton "Влево" action AnimateScroll("parallax_vp", "horizontal decrease", delay=0.3, warper="ease")
###        textbutton "Вправо" action AnimateScroll("parallax_vp", "horizontal increase", delay=0.3, warper="ease")
###        textbutton "Вверх" action AnimateScroll("parallax_vp", "vertical decrease", delay=0.3, warper="ease")
###        textbutton "Вниз" action AnimateScroll("parallax_vp", "vertical increase", delay=0.3, warper="ease")
...
#define gui.text_font = "Dutch801 Rm Win95BT.ttf"
...
define gui.main_menu_background = "gui/game_menu2.png"
...
define gui.nvl_borders = Borders(0, 350, 0, 30)
